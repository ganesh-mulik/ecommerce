...
export const routes: Routes = [
    ...
    //admin
    {path:'',children:[{path:"admin-login",component:AdminLoginComponent}]},
    {path:'',children:[{path:"admin-dashboard",component:AdminDashboardComponent},
        {path:"admin/user",component:UserCrudComponent},
        {path:"admin-product",component:ProductComponent}
    ]},
    {path:'',children:[{path:"sign-in",component:SigninSignupComponent},
        {path:"sign-up",component:SigninSignupComponent}        
    ]},
    {path:'',children:[{path:"seller-dashboard",component:SellerDashboardComponent},
        {path:"seller/product",component:ProductComponent}        
    ]},
    {path:'',children:[{path:"buyer-dashboard",component:BuyerDashboardComponent},
